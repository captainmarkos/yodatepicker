...
var yolib = {
    get_max_date: function(param_max_date) {
    ...
    get_min_date: function(param_min_date) {
    ...
    get_dow_names: function(locale, dow_heading) {
        var names = [];
        switch(dow_heading) {
            case 'single_name':
                names = this.dow_single_names(locale);
                break;
            case 'short_name':
                names = this.dow_short_names(locale);
                break;
            case 'full_name':
                names = this.dow_full_names(locale);
                break;
            default:
                names = this.dow_single_names(locale);
        }
    ...
    get_month_names: function(locale) {
    ...
    dow_single_names: function(locale) {
        var names = [];
        switch(locale) {
            case 'es':
                names = ['D', 'L', 'M', 'M', 'J', 'V', 'S'];
    ...
    dow_short_names: function(locale) {
        var names = [];
        switch(locale) {
            case 'es':
    ...
    dow_full_names: function(locale) {
        var names = [];
        switch(locale) {
            case 'es':
    ...
    days_in_month: function(month_num, full_year) {
        // Jan == 0, Feb == 1, Mar == 2, ...
        ...
        return(this.leap_year(full_year) ? 29 : 28);
    },
